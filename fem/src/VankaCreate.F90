...
!-------------------------------------------------------------------------------
!> Circuit preconditioner for real systems: field part by ILU (or identity),
!> circuit block by a dense LU solved redundantly on all ranks (CircuitAuxPrec).
!-------------------------------------------------------------------------------
...
!-------------------------------------------------------------------------------
      ...
      REAL(KIND=dp) u(*), v(*)
!-------------------------------------------------------------------------------
      CALL CircuitBlockPrecReal(u, v, ipar)
!-------------------------------------------------------------------------------
    END SUBROUTINE CircuitPrec
!-------------------------------------------------------------------------------

!-------------------------------------------------------------------------------
!> Circuit preconditioner for complex systems: field part by ILU, identity or the
!> edge auxiliary space cycle (Hypre AMS), circuit block by a dense LU (CircuitAuxPrec).
!-------------------------------------------------------------------------------
...
!-------------------------------------------------------------------------------
      ...
      COMPLEX(KIND=dp) u(*), v(*)
!-------------------------------------------------------------------------------
      CALL CircuitBlockPrecComplex(u, v, ipar)
!-------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
!> Set up the circuit preconditioner for the current linear solve.
!------------------------------------------------------------------------------
...
!------------------------------------------------------------------------------
     CALL CircuitBlockCreate(A, Solver)
!------------------------------------------------------------------------------
